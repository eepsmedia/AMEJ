...
::: {.column-margin}
![](art/beads-on-scale.png){width="90%"}
:::
...
The mass will be of the bowl plus the beads.
Do not alert the students to this!]
* Enter the `count` and the `mass` into a CODAP table. 
* Put the beads back into the container and repeat.
...
::: {.column-margin}
![The ruler palette is attached to the graph.](art/ruler-palette-movable-line.png){width="50%"}
:::


You already know [how to make a graph](050-basics.qmd).
To make a line,
...
::: {.column-page-right}
<script>
    theURL = "https://codap.concord.org/releases/latest/static/dg/en/cert/index.html#shared=https%3A%2F%2Fcfm-shared.concord.org%2FQlXPoFoFsrzmRGJ1h8YF%2Ffile.json";
...
* Suppose we put 100 beads in the bowl. What would the mass be?
* Suppose the bowl with the beads had a mass of 1 kg. 
...
::: {.column-margin}
![One possible line](art/modelling%20good%20fit.png)
:::
...
it's possible that the true formula is `mass = 2 * count + 100`?

:::{.callout-tip}
## Need more screen space?

Working inside this site can be constraining. 
To see this CODAP file "normally," in your browser,
[use this link](https://codap.concord.org/releases/latest/static/dg/en/cert/index.html#shared=https%3A%2F%2Fcfm-shared.concord.org%2FQlXPoFoFsrzmRGJ1h8YF%2Ffile.json){target="_blank"}.
:::
### More commentary
