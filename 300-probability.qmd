...
This article is all about experimenting with probability in CODAP.

### Examples from the journal article

* [Rolling dice](310-prob-dice-30-1200.qmd)
* [Flipping two coins](320-two-coins-1000.qmd)
* [Flipping ten coins](330-ten-coins.qmd)

### Something fun and different: Roulette!

On the [Modelling](100-modelling.qmd) page,
...
surrounds the name `'not red'` with back-ticks. 
...
Check out [this chapter in the online book, *Awash in Data*](https://codap.xyz/awash/07.10-binomial.html){target="_blank"}.
