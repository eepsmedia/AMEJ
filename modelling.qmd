...
You already know [how to make a graph](basics.qmd).
To make a line,
...
::: {.column-page-right}
<script>
    theURL = "https://codap.concord.org/releases/latest/static/dg/en/cert/index.html#shared=https%3A%2F%2Fcfm-shared.concord.org%2FmNGEjBMnqPPPtTiEQeJh%2Ffile.json";
...
::: {.column-margin}
![One possible line](art/good-fit.png)
:::
...
[use this link](https://codap.concord.org/releases/latest/static/dg/en/cert/index.html#shared=https%3A%2F%2Fcfm-shared.concord.org%2FmNGEjBMnqPPPtTiEQeJh%2Ffile.json){target="_blank"}.
:::
### More commentary
